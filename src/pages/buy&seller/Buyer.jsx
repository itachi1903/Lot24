      ...
      <section className="container  bg-white shadow-md -translate-y-4 mx-auto py-10 border">
        ...
        <div className="p-4 my-10">
          ...
          {[
            ...
            <div
              key={index}
              className={`flex whitespace-pre-wrap flex-col md:flex-row ${index % 2 === 1 ? "md:flex-row-reverse" : ""
        ...
        <div className="my-4 md:px-[200px] text-center bg-gray-50 py-4  ">
          To sum up, the Lot24 wholesale trading platform supports building a network of business contacts. It makes it easier to find reliable wholesalers who offer stocks from the industry that the buyer is interested in, and also enables quick and easy contact with the wholesaler and the purchase of products at the best prices on the market.
        </div>
