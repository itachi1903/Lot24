...
const Seller = () => {
  return (
    <>
      ...
      {/* Main Section */}
      <section className="container bg-white shadow-md -translate-y-4 mx-auto py-10 border">
        {/* What is Lot24 */}
        <div className="w-[90%] mx-auto flex flex-wrap md:flex-nowrap gap-6">
          ...
          <div className="w-full md:w-3/4 p-2">
            ...
            <p className="text-xl  ">
              Lot24 is an international wholesale portal connecting sellers with global buyers. Showcase your products, surplus stock, and exclusive offers to a worldwide audience and drive wholesale success.
            </p>
          </div>
        </div>
        ...
        <div className="px-8 bg-[#FFEBC7] py-8 mt-7 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { icon: "fa-earth-asia", count: "150+", label: "Countries worldwide" },
          ].map((stat, index) => (
            <div
              key={index}
        ...
        <div className="my-8">
          ...
          <p className="text-xl text-center max-w-3xl mx-auto">
            At Merkandi, we understand that sellers' success in wholesale depends on access to the best business tools. That is why, we have created a platform for sellers that offers numerous benefits:
          </p>
        ...
        <div className="my-10 p-8 bg-blue-400 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-white text-center md:text-left">
            ...
            <h2 className="text-lg text-[#282828]  ">
              Join over 100,000 successful sellers and grow your business globally.
            </h2>
          </div>
          <Link to="/register">
        ...
        <div className="py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
            {[
              { stars: 5, name: "Alex son", review: "We are very happy to use the platform. There are great verified traders and super offers both in Germany and abroad." },
              { stars: 4, name: "Martha", review: "A useful platform for buying and selling, very reliable. A large number of interesting offers at good prices, which makes it possible to earn a lot of money." },
              { stars: 5, name: "Diana", review: "It is a very good platform for finding wholesellers and also for selling. It's been a year since I started using it. It's been very beneficial to my business." },
            ].map((review, index) => (
              <div
                key={index}
