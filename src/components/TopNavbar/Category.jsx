        ...
        <>
                ...
                <div className='py-3 hidden lg:flex justify-between items-center '>
                    <div className="flex items-center gap-6 text-light">
                        <div className="bg-[#1d7094] dropdown py-2 min-w-[250px]">
                            ...
                            <ul className="dropdown-menu w-full mt-2" aria-labelledby="Categories">
                        ...
                        <div className="flex items-center gap-6 text-gray-200">
                            <Link to="#" className="px-4 py-2 text-lg hover:text-white font-bold transition duration-300 ease-in-out">
                                Products
                            </Link>
                            <Link to="#" className="py-2 px-4 text-lg hover:text-white font-bold transition duration-300 ease-in-out">
                                Stocks
                            </Link>
                            <Link to="#" className="py-2 px-4 text-lg hover:text-white font-bold transition duration-300 ease-in-out">
                                Wholesalers
                    ...
                    <div>
                        <a href="#" className="py-3 px-6 bg-[#f29d00] text-white font-bold rounded-md hover:bg-[#fbc053] transition duration-300 ease-in-out">
                            Add offers
            ...
            <div className="lg:hidden flex justify-between items-center bg-[#299BCC] py-3">
                ...
                >
                    ...
                    <div className="px-6 py-4">
                        <Link to="#" className="block text-white py-2 hover:bg-[#fbc053] rounded-md">
                            Products
                        </Link>
                        <Link to="#" className="block text-white py-2 hover:bg-[#fbc053] rounded-md">
                            Stocks
