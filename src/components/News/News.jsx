            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div className=" flex items-center md:text-left 2xl:gap-8">
                    ...
                    <div>
                        ...
                        <p className="mt-2 md:mt-0">Daily updates about new products and news about Lot24.</p>
                    </div>
                </div>
                {/* Subscription Form */}
                <div className='w-fit max-w-[1080px]'>
                    <div className="flex flex-col md:flex-row items-center w-full md:w-auto">
                        ...
                        >
                            <button
                                className="p-[12px] bg-gray-200 text-gray-800 text-xs w-full md:w-auto cursor-pointer"
                            >
                    ...
                    <p className='text-gray-400 max-w-[450px] mt-3 md:mt-0'>
                        By subscribing to our newsletter, you consent to the processing of your personal data for marketing purposes.
                    </p>
                </div>
            </div>
        </section>
